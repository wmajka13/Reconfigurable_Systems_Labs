...
def main():
    ...
    # command_test = "loadi 3, 97\n"

    # for i, letter in enumerate(command_test):
    #     print(f"{i} : {letter}")
    
    # print(parse_line(command_test))
    path = "/home/wiktor-majka/Documents/Vivado_projects/SR_procesor/SR_procesor.srcs/sources_1/new/"
    
    read_file_and_parse(path + "program13_5.asm", path + "program13_5.mc")    
